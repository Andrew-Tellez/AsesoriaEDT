 ...
 * 
 * @author Libardo Pantoja Adaptado de:
 *         http://stackoverflow.com/questions/4965335/how-to-print-binary-tree-diagram
 * 
 *         Forma de usarlo: ArbolBinarioBusqueda arbol = new
 *         ArbolBinarioBusqueda(); ... BTreePrinter.printNode(arbol.getRaiz());
 */
public class BTreePrinter {
	...
	private static void printNodeInternal(List<Nodo> nodes, int level, int maxLevel) {
